...
const prefix = prefixedString('[grpc Event Store PostgreSQLAdapter] ')
const validateConfig = ({
  ...
  if (!isString(password) || isEmpty(password)) throw new TypeError(prefix(`config.password MUST be a non empty string. Received ${password}`))
